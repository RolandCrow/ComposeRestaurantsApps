...
import com.example.restaurant_app_presentation_pattern.viewmodel.RestaurantsViewModel
...
fun RestaurantItem(
    ...
    Card(
        ...
        Row(
            ...
            RestaurantDetails(item.title,item.description, Modifier.weight(0.15f))
            RestaurantIcon(icon, Modifier.weight(0.15f)) {
                onFavoriteClick(item.id,item.isFavorable)
            }
        }
    }
}
